# -*- coding: utf-8 -*-
"""
Created on Tue May 18 11:14:44 2021
...
fileloc_3 = "J:\Depot - dDAVP-time course - Kirby\BayesAnalysis\\BayesTC complete calc_python V12.xlsx"
...
from bayesmodules import cMBF_calc
bayes_IB = selectpos_bayes('IB',int_pos,coloc_vec)
...
from openpyxl import load_workbook
for v in rest_clus:
    bayes_clus = selectpos_bayes(v,int_pos,coloc_vec)
