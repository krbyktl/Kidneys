...
lenplot = sns.histplot(lengths,binwidth=20)
lenplot.set(xlabel = 'Number of peptides per kinase')
lenplot = sns.set_style('white')
lenplot = sns.set_style('ticks')
lenplot = sns.despine()
plt.tight_layout()
plt.savefig("J:\Depot - dDAVP-time course - Kirby\Figures\Sugiyama sample size per kinase",
            dpi=600)
...
fileloc_3 = "J:\Depot - dDAVP-time course - Kirby\BayesAnalysis\\STY dot product ranking 355.xlsx"
...
# %%
writer=pd.ExcelWriter("J:\Depot - dDAVP-time course - Kirby\BayesAnalysis\\position rankings_V3IC.xlsx")
